...
def thread_worker(start, end, param_combinations, X_train, X_val, y_train, y_val, results_queue):
...
def thread_search(X_train, X_val, y_train, y_val, num_threads=6):
    ...
    for i in range(num_threads):
        ...
        thread = threading.Thread(target=thread_worker, args=(start, end, param_combinations, X_train, X_val, y_train, y_val, results_queue))
